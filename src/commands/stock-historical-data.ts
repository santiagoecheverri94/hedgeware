...
import {
    saveStockHistoricalDailyDataForStockFromStartToEndDate,
...
export default class StockHistoricalData extends Command {
    ...
    static args = {
        ...
        startDate: Args.string({
            description: 'start date, YYYY-MM-DD, of historical data',
            required: true,
        }),
        endDate: Args.string({
            description: 'end date, YYYY-MM-DD, of historical data',
            required: false,
        }),
    };
    ...
    public async run(): Promise<void> {
        ...
        if (args.endDate) {
            await saveStockHistoricalDailyDataForStockFromStartToEndDate(
                args.stock,
                args.startDate,
                args.endDate,
            );
